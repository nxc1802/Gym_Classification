...
\begin{enumerate}[leftmargin=*, itemsep=2pt, topsep=1pt]
    ...
    \item \textbf{Đoạn 12 (C4: Kết hợp Cross-Paradigm, Benchmark thực nghiệm \& Triển khai thời gian thực):} Kết hợp Transformer và Four-Stream AAGCN ($\approx 350\text{K}$ params) qua tối ưu hóa SLSQP không rò rỉ trên validation; thực nghiệm toàn diện đa seed, kiểm định McNemar/Wilcoxon đạt 70.03\% window và 77.68\% video consensus; đạt độ trễ 0.42--4.33 ms CPU phục vụ triển khai thời gian thực trên thiết bị biên.
\end{enumerate}
\end{secbox}
