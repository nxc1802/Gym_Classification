...
\begin{enumerate}[leftmargin=*, itemsep=2pt, topsep=1pt]
    ...
    \item \textbf{Đoạn 6 (Rào cản 3 - Augmentation phi sinh học):} Các phép biến đổi không gian thông thường (kéo giãn không đều, xoay 3D tự do) làm méo mó chiều dài xương và góc khớp, tạo ra tư thế bất khả thi về mặt giải phẫu.
    ...
    \item \textbf{Đoạn 11 (C3: Sinh cơ SkelGym-Aug):} Xây dựng giao thức tăng cường dữ liệu bảo toàn cấu trúc giải phẫu qua đối xứng trục dọc (sagittal reflection) và xoay quanh trục trọng lực (yaw rotation) chỉ chạy khi training.
