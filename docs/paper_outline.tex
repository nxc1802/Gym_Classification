...
\begin{enumerate}[leftmargin=*, itemsep=2pt, topsep=1pt, start=51]
    ...
    \item \textbf{Detrimental Impact of Temporal Warping \& Final SkelGym-Aug Selection:} Phát hiện việc loại bỏ TimeWarp giúp độ chính xác tăng vọt +1.41\% (đạt 67.82\% $\pm$ 0.96\%) và độ lệch chuẩn giảm 39.2\%; phân tích cơ sinh học cho thấy biến dạng thời gian phá vỡ nhịp tập (cadence/tempo) và tỷ lệ co giãn cơ tâm sai/hướng tâm; chốt cấu hình SkelGym-Aug gồm 4 toán tử (Mirror, Yaw, Scale, Jitter).
