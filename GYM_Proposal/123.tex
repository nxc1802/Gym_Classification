...
\begin{figure}[H]
    ...
    \begin{center}
    \resizebox{0.9\textwidth}{!}{\includegraphics{Dataset.png}}
    \end{center}
...
\hline
Videos                & 580            & 208          & 236           & 1\,024         \\
Segments              & 639            & 210          & 259           & 1\,108         \\
Pose-samples          & 14\,324        & 2\,574       & 2\,544        & 19\,442        \\
Swin3D-samples        & 7\,203         & 2\,245       & 2\,924        & 12\,372        \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
    % \hspace*{-1.5cm} % <-- Đẩy ảnh qua bên trái
    \begin{center}
        \resizebox{0.98\textwidth}{!}{\includegraphics{Pipeline.jpg}}
        \caption{Pipeline}
    \end{center}
    \label{fig:pipeline}
\end{figure}
...
\begin{figure}[H]
    \hspace*{-1.5cm} % <-- Đẩy ảnh qua bên trái
    \begin{center}
        \resizebox{0.7\textwidth}{!}{\includegraphics{confusion_matrix_stacking.png}}
    \end{center}
\end{figure}
...
Swin3D-B & ImageNet-22K + Kinetics-400 & 0.5807 \\
\hline
\end{tabular}
\end{table}
